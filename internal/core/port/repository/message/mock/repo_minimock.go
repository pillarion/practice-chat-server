...
//go:generate minimock -i github.com/pillarion/practice-chat-server/internal/core/port/repository/message.Repo -o repo_minimock.go -n RepoMock -p mock
...
// RepoMock implements message.Repo
type RepoMock struct {
	t          minimock.Tester
	finishOnce sync.Once

	funcInsert          func(ctx context.Context, message *model.Message) (err error)
	inspectFuncInsert   func(ctx context.Context, message *model.Message)
	afterInsertCounter  uint64
	beforeInsertCounter uint64
	InsertMock          mRepoMockInsert
}

// NewRepoMock returns a mock for message.Repo
...
func (mmInsert *mRepoMockInsert) Expect(ctx context.Context, message *model.Message) *mRepoMockInsert {
	...
	mmInsert.defaultExpectation.params = &RepoMockInsertParams{ctx, message}
...
func (mmInsert *mRepoMockInsert) Inspect(f func(ctx context.Context, message *model.Message)) *mRepoMockInsert {
...
func (mmInsert *mRepoMockInsert) Return(err error) *RepoMock {
	if mmInsert.mock.funcInsert != nil {
		mmInsert.mock.t.Fatalf("RepoMock.Insert mock is already set by Set")
	}
	...
	mmInsert.defaultExpectation.results = &RepoMockInsertResults{err}
	return mmInsert.mock
}

// Set uses given function f to mock the Repo.Insert method
func (mmInsert *mRepoMockInsert) Set(f func(ctx context.Context, message *model.Message) (err error)) *RepoMock {
	if mmInsert.defaultExpectation != nil {
...
// Then helper
func (mmInsert *mRepoMockInsert) When(ctx context.Context, message *model.Message) *RepoMockInsertExpectation {
	if mmInsert.mock.funcInsert != nil {
		mmInsert.mock.t.Fatalf("RepoMock.Insert mock is already set by Set")
	}
	...
	expectation := &RepoMockInsertExpectation{
		mock:   mmInsert.mock,
		params: &RepoMockInsertParams{ctx, message},
	}
...
func (e *RepoMockInsertExpectation) Then(err error) *RepoMock {
	e.results = &RepoMockInsertResults{err}
	return e.mock
}

// Insert implements message.Repo
func (mmInsert *RepoMock) Insert(ctx context.Context, message *model.Message) (err error) {
	...
	if mmInsert.inspectFuncInsert != nil {
		mmInsert.inspectFuncInsert(ctx, message)
	}

	mm_params := RepoMockInsertParams{ctx, message}
	...
	if mmInsert.InsertMock.defaultExpectation != nil {
		...
		mm_got := RepoMockInsertParams{ctx, message}
	...
	if mmInsert.funcInsert != nil {
		return mmInsert.funcInsert(ctx, message)
	}
	mmInsert.t.Fatalf("Unexpected call to RepoMock.Insert. %v %v", ctx, message)
	return
}
